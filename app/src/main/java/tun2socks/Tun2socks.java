...
import go.Seq;
/* loaded from: tun2socks.aar:classes.jar:tun2socks/Tun2socks.class */
public abstract class Tun2socks {

    /* loaded from: tun2socks.aar:classes.jar:tun2socks/Tun2socks$proxyDBService.class */
    private static final class proxyDBService implements Seq.Proxy, DBService {
        private final int refnum;

        proxyDBService(int i) {
            this.refnum = i;
        ...
        public native void insertProxyLog(String str, String str2, long j, long j2, int i, int i2, int i3, int i4, String str3, String str4, int i5);
    }

    /* loaded from: tun2socks.aar:classes.jar:tun2socks/Tun2socks$proxyPacketFlow.class */
    ...
    /* loaded from: tun2socks.aar:classes.jar:tun2socks/Tun2socks$proxyVpnService.class */

...
public class Preferences {
    ...
    public String getSocksAddress() {
        return this.prefs.getString(SOCKS_ADDR, "192.168.31.154");
    }
    ...
    public int getSocksPort() {
        return this.prefs.getInt(SOCKS_PORT, 2024);
    }
    ...
    public boolean getxitong() {
        return this.prefs.getBoolean("xitong", true);
    }

    public void setxitong(boolean enable) {
        SharedPreferences.Editor editor = this.prefs.edit();
        editor.putBoolean("xitong", enable);
        editor.commit();
    }

    public boolean getGlobal() {
        return this.prefs.getBoolean(GLOBAL, true);
    }
    ...
    public boolean getguanyu() {
        return this.prefs.getBoolean("guanyu", false);
    }

    public void setguanyu(boolean enable) {
        SharedPreferences.Editor editor = this.prefs.edit();
        editor.putBoolean("guanyu", enable);
        editor.commit();
    }


    public boolean getvpn() {
        return this.prefs.getBoolean("gvpn", false);
    }

    public void setvpn(boolean enable) {
        SharedPreferences.Editor editor = this.prefs.edit();
        editor.putBoolean("gvpn", enable);
        editor.commit();
    }
